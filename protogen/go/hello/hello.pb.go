...
func (x *HelloRes) GetGreet() string {
	if x != nil {
		return x.Greet
	}
	return ""
...
const file_proto_hello_hello_proto_rawDesc = "" +
	"\n" +
	"\x17proto/hello/hello.proto\x12\x05hello\"0\n" +
	"\bHelloReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x10\n" +
	"\x03age\x18\x10 \x01(\rR\x03age\" \n" +
	"\bHelloRes\x12\x14\n" +
	"\x05greet\x18\x01 \x01(\tR\x05greet29\n" +
	"\fHelloService\x12)\n" +
	"\x05Hello\x12\x0f.hello.HelloReq\x1a\x0f.hello.HelloResB7Z5github.com/faujiahmat/my-grpc-proto/protogen/go/hellob\x06proto3"
