...
type BankServiceClient interface {
	GetCurrentBalance(ctx context.Context, in *CurrentBalanceReq, opts ...grpc.CallOption) (*CurrentBalanceRes, error)
	FetchExchangeRates(ctx context.Context, in *ExchangeRateReq, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExchangeRateRes], error)
	...
	TransferMultiple(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TransferReq, TransferRes], error)
...
func (c *bankServiceClient) GetCurrentBalance(ctx context.Context, in *CurrentBalanceReq, opts ...grpc.CallOption) (*CurrentBalanceRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CurrentBalanceRes)
...
func (c *bankServiceClient) FetchExchangeRates(ctx context.Context, in *ExchangeRateReq, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ExchangeRateRes], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BankService_ServiceDesc.Streams[0], BankService_FetchExchangeRates_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ExchangeRateReq, ExchangeRateRes]{ClientStream: stream}
...
type BankService_FetchExchangeRatesClient = grpc.ServerStreamingClient[ExchangeRateRes]
...
func (c *bankServiceClient) TransferMultiple(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TransferReq, TransferRes], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BankService_ServiceDesc.Streams[2], BankService_TransferMultiple_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[TransferReq, TransferRes]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_TransferMultipleClient = grpc.BidiStreamingClient[TransferReq, TransferRes]

func (c *bankServiceClient) CreateAccount(ctx context.Context, in *CreateAccountReq, opts ...grpc.CallOption) (*CreateAccountRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BankServiceServer interface {
	GetCurrentBalance(context.Context, *CurrentBalanceReq) (*CurrentBalanceRes, error)
	FetchExchangeRates(*ExchangeRateReq, grpc.ServerStreamingServer[ExchangeRateRes]) error
	SummarizeTransactions(grpc.ClientStreamingServer[Transaction, TransactionSummary]) error
	TransferMultiple(grpc.BidiStreamingServer[TransferReq, TransferRes]) error
...
func (UnimplementedBankServiceServer) GetCurrentBalance(context.Context, *CurrentBalanceReq) (*CurrentBalanceRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCurrentBalance not implemented")
}
func (UnimplementedBankServiceServer) FetchExchangeRates(*ExchangeRateReq, grpc.ServerStreamingServer[ExchangeRateRes]) error {
...
func (UnimplementedBankServiceServer) TransferMultiple(grpc.BidiStreamingServer[TransferReq, TransferRes]) error {
	return status.Errorf(codes.Unimplemented, "method TransferMultiple not implemented")
}
func (UnimplementedBankServiceServer) CreateAccount(context.Context, *CreateAccountReq) (*CreateAccountRes, error) {
...
func _BankService_GetCurrentBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankServiceServer).GetCurrentBalance(ctx, req.(*CurrentBalanceReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _BankService_FetchExchangeRates_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ExchangeRateReq)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BankServiceServer).FetchExchangeRates(m, &grpc.GenericServerStream[ExchangeRateReq, ExchangeRateRes]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_FetchExchangeRatesServer = grpc.ServerStreamingServer[ExchangeRateRes]
...
func _BankService_TransferMultiple_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BankServiceServer).TransferMultiple(&grpc.GenericServerStream[TransferReq, TransferRes]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BankService_TransferMultipleServer = grpc.BidiStreamingServer[TransferReq, TransferRes]
...
func _BankService_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BankServiceServer).CreateAccount(ctx, req.(*CreateAccountReq))
	}
	return interceptor(ctx, in, info, handler)
}
